...
class Ship:
    ...
    def get_height(self):
        ...
        #(window, (255,0,0), (self.x, self.y, 50, 50), 2) for a hollow shape, 2 is like the thickness
...
def main():
    ...
    main_fonts = pygame.font.SysFont("timesnewroman", 50)
    lost_fonts = pygame.font.SysFont("timesnewroman", 60)
    ...
    def redraw_window():
        WIN.blit(BG, (0,0))  #blit - loads an image at set coordinates
        # Draw text
        lives_label = main_fonts.render(f"Lives: {lives}", 1, (255, 255, 255))
        level_label = main_fonts.render(f"Level: {level}", 1, (255, 255, 255))
